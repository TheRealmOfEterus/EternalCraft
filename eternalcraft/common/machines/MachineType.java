...
public enum MachineType {
	BASE(TileEntityMachine.class, new String[] {}, -1), FURNACE(TileEntityECFurnace.class, new String[] { "decrementValue", "material" }, Eternalcraft.GUI_ID++);
	...
	public final void makeIcons(IconRegister registrar) {
		icons = new Icon[4];
		int counter = 0;
	...
	public final Icon getIconBySide(int side, int dir, boolean isActive) {
		if (dir == 0 || dir == 3) {
			switch (side) {
			case TextureHelper.TOP:
				return icons[0];
			case TextureHelper.BOTTOM:
				return icons[0];
			case TextureHelper.FRONT:
				return icons[1];
			default:
				return icons[3];
			}
	...
	public static final TileEntity makeTileEntity(int meta) {
