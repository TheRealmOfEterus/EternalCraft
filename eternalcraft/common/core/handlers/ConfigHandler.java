...
public class ConfigHandler {
	 ...
	 */
	public static final EternalcraftSettings loadConfig(Configuration theConfig) {
	...
	public static final int getItem(Configuration config, String name, int defaultID) {
		return config.getItem(name, defaultID).getInt(defaultID);
	}

	public static final int getBlock(Configuration config, String name, int defaultID) {
